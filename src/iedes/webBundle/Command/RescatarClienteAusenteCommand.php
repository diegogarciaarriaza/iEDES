...
class RescatarClienteAusenteCommand extends ContainerAwareCommand{
    
    protected function configure(){
    
        $this->setName('visitas:rescate_visita_cliente_ausente')
            ->setDescription('Convierte en rescatable las visitas con cliente ausente')
    ...
    protected function execute(InputInterface $input, OutputInterface $output){
        ...
        $query = $em->getRepository("iedeswebBundle:Visitas")->createQueryBuilder('v')
              ->where("v.fechaVisita < '" . $date->format('Y-m-d') . "'" .
                      ...
                      " and v.resultadovisitas = 11 and v.rescatar = 0")
        ...
        $contenedor->get("email_service")->sendmail( 
              ...
              $to,
              'Rescates por Visita con Cliente Ausente',
              $msg);
    }
}
