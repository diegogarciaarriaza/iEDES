...
class RescatarPresupuestoRechazadoCommand extends ContainerAwareCommand{
    
    protected function configure(){
    
        $this->setName('visitas:rescate_presupuesto_rechazado')
            ->setDescription('Convierte en rescatable las visitas con presupuesto rechazado')
    ...
    protected function execute(InputInterface $input, OutputInterface $output){
        ...
        $query = $em->getRepository("iedeswebBundle:Visitas")->createQueryBuilder('v')
              ->where("v.fechaVisita < '" . $date->format('Y-m-d') . "'" .
                      ...
                      " and v.resultadovisitas = 2 and v.rescatar = 0")
        ...
        $contenedor->get("email_service")->sendmail( 
              ...
              $to,
              'Rescates por Presupuesto Rechazado',
              $msg);
    }
}