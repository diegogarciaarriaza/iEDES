		...
		*{
        ...
        <table border="0" cellspacing="0" width="100%">
            ...
            <tr>
                <td></td>
                <td width="650">
                    <h1>Gracias por contactar con iEDES Solenergy, <br/> el Gigante de la Energía Solar.</h1>
                    <h3>Has completado correctamente nuestro formulario relativo a:</h3>
                    <h3><strong><?php echo $nombreformulario?></strong></h3>
