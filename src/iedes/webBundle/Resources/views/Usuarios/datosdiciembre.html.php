...
<?php //procesaremos posteriormente
    $arrayVisitas = array();
    if(isset($instalaciones6)){$arrayVisitas["Instalaciones"] = $instalaciones6;}
    if(isset($instalaciones13)){$arrayVisitas["Ventas de Extras"] = $instalaciones13;}
    if(isset($entradas)){$arrayVisitas["Entradas en viviendas"] = $entradas;}
    if(isset($otras)){$arrayVisitas["Otras visitas"] = $otras;}
?>
